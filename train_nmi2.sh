python main_test_swinir.py --task classical_sr --scale 4 --training_patch_size 64 \
    ...
    --savedir /home/xiaoyun/Code/RefCode/KAIR/model_zoo/model_w_pseudo/swinir_NMI_x4_psnr_pseudo/sr_results_train_60000
...
python main_test_swinir.py --task classical_sr --scale 4 --training_patch_size 64 \
    ...
    --savedir /home/xiaoyun/Code/RefCode/KAIR/model_zoo/model_w_pseudo/swinir_NMI_x4_psnr_pseudo/sr_results_pseudo_60000

python main_test_swinir.py --task classical_sr --scale 4 --training_patch_size 64 \
    --model_path /home/xiaoyun/Code/RefCode/KAIR/model_zoo/model_w_pseudo/swinir_NMI_x4_psnr_pseudo/models/60000_G.pth \
    --folder_lq /data/hdd/Data/GCI/Final/data/test/micro/lr128 \
    --folder_gt /data/hdd/Data/GCI/Final/data/test/micro/gt \
    --savedir /home/xiaoyun/Code/RefCode/KAIR/model_zoo/model_w_pseudo/swinir_NMI_x4_psnr_pseudo/sr_results_test_60000
